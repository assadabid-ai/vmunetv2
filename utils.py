...
def dilate_image(input_array, thresholod):
    ...
    # MORPHOLOGY:
    output_mask = morphology.binary_erosion(output_mask, footprint=morphology.square(3))
    output_mask = morphology.binary_dilation(output_mask, footprint=morphology.square(6))
